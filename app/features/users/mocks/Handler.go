...
// DeleteProfile provides a mock function with given fields:
func (_m *Handler) DeleteProfile() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *Handler) GetProfile() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *Handler) UpdateProfile() echo.HandlerFunc {
	ret := _m.Called()
